...
## MAIN SETTINGS
// time zone
$ourTZ         = $config['noaa']['timezone'];        // *** Time Zone     http://www.php.net/manual/en/timezones.america.php

// folders
$cacheFileDir  = '/var/www/html/cache/';                // *** default cache file directory
$icons_folder  = '/var/www/html/alert-images';          // folder that contains the icons. No slash on end
...
$alertURL      = 'wx_details.php';       // web page file name for complete details - Used for standard web pages
$summaryURL    = 'wx_summary.php';       // web page for the alert summary - Used for standard web pages
...
$log_folder    = '/var/www/html/alertlog'; // folder that contains the log files. No slash on end
